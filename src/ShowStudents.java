...
public class ShowStudents extends javax.swing.JFrame {
    ...
    private void setupTable() {
        ...
        String[] columnNames = {"ID", "Name", "Birthday", "Address", "Phone", "E-mail", "Class"};
        ...
        jTable1.getColumnModel().getColumn(1).setPreferredWidth(120);  // Name
        jTable1.getColumnModel().getColumn(2).setPreferredWidth(100);  // Birthday
        jTable1.getColumnModel().getColumn(3).setPreferredWidth(150);  // Address
        jTable1.getColumnModel().getColumn(4).setPreferredWidth(100);  // Phone
        jTable1.getColumnModel().getColumn(5).setPreferredWidth(120);  // E-mail
        jTable1.getColumnModel().getColumn(6).setPreferredWidth(60);   // Class
    ...
    /**
     * Load student data from database and populate the table
     */
    private void loadStudentData() {
        try {
            ...
            String sql = "SELECT stdid, stdname, stddob, stdaddress, stdphone, stdmail, class FROM student ORDER BY stdid";
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(sql);
                ...
                while (rs.next()) {
                    Object[] row = {
                        ...
                        rs.getDate("stddob") != null ? dateFormat.format(rs.getDate("stddob")) : "",
                        rs.getString("stdaddress"),
                        rs.getString("stdphone"),
                        rs.getString("stdmail"),
                        rs.getInt("class")
                    };
                ...
                if (tableModel.getRowCount() == 0) {
                    ...
                    setTitle("Show Students (" + tableModel.getRowCount() + " students)");
                }
                
            }
            
        } catch (SQLException e) {
            logger.log(java.util.logging.Level.SEVERE, "Database error while loading students", e);
            JOptionPane.showMessageDialog(this, 
                "Error loading student data: " + e.getMessage(), 
                "Database Error", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            logger.log(java.util.logging.Level.SEVERE, "Unexpected error while loading students", e);
            JOptionPane.showMessageDialog(this, 
    ...
    /**
     * Search for students by name (optional enhancement)
     */
    public void searchStudentByName(String searchTerm) {
        if (searchTerm == null || searchTerm.trim().isEmpty()) {
            loadStudentData(); // Show all if search is empty
            return;
        }
        ...
        try {
            ...
            String sql = "SELECT stdid, stdname, stddob, stdaddress, stdphone, stdmail, class " +
                        "FROM student WHERE stdname LIKE ? ORDER BY stdid";
            ...
            if (tableModel.getRowCount() == 0) {
                ...
                setTitle("Show Students - Search Results (" + tableModel.getRowCount() + " found)");
            }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Students", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 18), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Birthday", "Address", "Phone", "E-mail", "Class"
            }
        ));
        ...
        setSize(new java.awt.Dimension(749, 708));
